...
All bin images are pre-computed in a single HDF5 file at **`/home/takaji/xrd_3x3_bins.h5`**. Load any bin with:
...
1. For each bin in `bin_annotations.json`, plus the bins in `empty_bins.json`:
   a. Load the bin image from `/home/takaji/xrd_3x3_bins.h5`.
...
python <algorithm>.py \
    --bin-key <key> \
    --bins-h5 /home/takaji/xrd_3x3_bins.h5 \
