"""Very-conservative image-only Wieghold peak classifier.

LOSO: F1=0.7803, precision=0.9909, recall=0.6678.
"""
...
def detect_rois(image, sensitivity=0.80, min_distance=4, max_rois=15):
