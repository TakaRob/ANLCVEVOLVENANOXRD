...
\begin{figure}[H]
\centering
\includegraphics[width=0.86\linewidth]{appendix_xrdapp_shapes}
\caption{Three largest Scan\_0179 features at $3\times3$ binning, the largest
available for this scan. A peak was seeded in each band and the ROI grown from
it: the fixed manual box (left) bleeds into the serpentine-striped background,
while xrd-app (right) isolates each grain cleanly.}
